...
const HoFItem: FC<{
    ...
    return (
      <div className="hover:cursor-pointer hover:bg-primary/40 transition-all mx-2 flex flex-row items-center justify-center gap-5 lg:gap-11 font-mono bg-gray-400/40 backdrop-blur-sm py-2 px-8 rounded-lg">
